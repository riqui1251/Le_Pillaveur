...
MIG=20250613160000_visitor_device
...
docker run --rm -v le-pillaveur-db:/data alpine sh -c 'apk add sqlite >/dev/null 2>&1; sqlite3 /data/prod.db "PRAGMA table_info(SitePresence);" | grep lastDevice'
