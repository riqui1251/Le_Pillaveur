...
MIG=20250612120000_auth_feedback_reset
...
docker run --rm -v le-pillaveur-db:/data alpine sh -c 'apk add sqlite >/dev/null 2>&1; sqlite3 /data/prod.db ".tables" | grep -E "UserFeedback|PasswordResetToken"'
