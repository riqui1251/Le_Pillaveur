...
MIG=20250613140000_visitor_local_players
...
docker run --rm -v le-pillaveur-db:/data alpine sh -c 'apk add sqlite >/dev/null 2>&1; sqlite3 /data/prod.db "PRAGMA table_info(SitePresence);" | grep localPlayer'
