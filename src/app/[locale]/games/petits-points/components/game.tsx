    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">{t('game.placingTitle')}</h2>
          <p className="text-muted-foreground mb-4">
            {currentPlayer ? t('game.placingTurn', { name: currentPlayer.name }) : t('game.allPlaced')}
          </p>
           ...
           >
             ...
             <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/70 px-3 py-1 rounded-full text-sm">
              {t('game.zoneSize', { size: config.zoneRadius })}
            </div>
           </div>
         </div>
      ...
      return (
        <div className="space-y-6">
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">{t('game.configTitle')}</h2>
            <p className="text-muted-foreground mb-6">
              {t('game.configSubtitle')}
            </p>
          </div>

          <Card className="p-6">
            <h3 className="text-lg font-semibold mb-4 text-center">{t('game.previewTitle')}</h3>
             <div className="flex justify-center">
               <div className="relative game-square max-w-[440px] bg-gradient-to-br from-gray-800 to-gray-900 rounded-full border-4 border-gray-600">
                 ...
                 {/* Indicateur de durée */}
                 <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/70 px-3 py-1 rounded-full text-sm">
                  {t('game.zoneVisible', { seconds: customConfig.zoneDuration / 1000 })}
                </div>
               </div>
             </div>
             <div className="flex justify-center gap-4 mt-4">
               <Button 
                 ...
                 size="sm"
               >
                 {showPreview ? t('game.testInProgress') : t('game.testZone')}
              </Button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           <Card className="p-4">
             <div className="space-y-4">
               <div className="flex items-center gap-2">
                 ...
                 <h3 className="text-lg font-semibold">{t('game.zoneCount')}</h3>
               </div>
               <div className="space-y-2">
                 <Label htmlFor="zoneCount">{t('game.zoneCountLabel', { count: customConfig.zoneCount })}</Label>
                 <Slider
                   id="zoneCount"
                   min={3}
                   max={20}
           ...
           <Card className="p-4">
             <div className="space-y-4">
               <div className="flex items-center gap-2">
                 <Settings className="h-5 w-5" />
                 <h3 className="text-lg font-semibold">{t('game.zoneRadius')}</h3>
               </div>
               <div className="space-y-2">
                 <Label htmlFor="zoneRadius">{t('game.zoneRadiusLabel', { radius: customConfig.zoneRadius })}</Label>
                                   <Slider
                    id="zoneRadius"
                    min={0}
                    max={250}
           ...
           <Card className="p-4">
             <div className="space-y-4">
               <div className="flex items-center gap-2">
                 <Settings className="h-5 w-5" />
                 <h3 className="text-lg font-semibold">{t('game.sipsPerZone')}</h3>
               </div>
               <div className="space-y-2">
                 <Label htmlFor="sipsPerZone">{t('game.sipsPerZoneLabel', { count: customConfig.sipsPerZone })}</Label>
                 <Slider
                   id="sipsPerZone"
                   min={1}
                   max={10}
           ...
           <Card className="p-4">
             <div className="space-y-4">
               <div className="flex items-center gap-2">
                 <Settings className="h-5 w-5" />
                 <h3 className="text-lg font-semibold">{t('game.zoneDuration')}</h3>
               </div>
               <div className="space-y-2">
                 <Label htmlFor="zoneDuration">{t('game.zoneDurationLabel', { seconds: customConfig.zoneDuration / 1000 })}</Label>
                 <Slider
                   id="zoneDuration"
                   min={1000}
                   max={5000}
           ...
           <Card className="p-4">
             <div className="space-y-4">
               <div className="flex items-center gap-2">
                 <Settings className="h-5 w-5" />
                 <h3 className="text-lg font-semibold">{t('game.spawnDelay')}</h3>
               </div>
               <div className="space-y-2">
                 <Label htmlFor="spawnDelay">{t('game.spawnDelayLabel', { seconds: customConfig.spawnDelay / 1000 })}</Label>
                 <Slider
                   id="spawnDelay"
                   min={500}
                   max={3000}
           ...
           <Card className="p-4 md:col-span-2">
             <div className="space-y-4">
               <h3 className="text-lg font-semibold">{t('game.configSummary')}</h3>
               <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                 <div className="text-center p-2 bg-gray-800 rounded">
                   <div className="font-semibold">{customConfig.zoneCount}</div>
                   <div className="text-muted-foreground">{t('game.summaryZones')}</div>
                 </div>
                 <div className="text-center p-2 bg-gray-800 rounded">
                   <div className="font-semibold">{customConfig.zoneRadius}px</div>
                   <div className="text-muted-foreground">{t('game.summarySize')}</div>
                 </div>
                 <div className="text-center p-2 bg-gray-800 rounded">
                   <div className="font-semibold">{customConfig.sipsPerZone}</div>
                   <div className="text-muted-foreground">{t('game.summarySipsPerZone')}</div>
                 </div>
                 <div className="text-center p-2 bg-gray-800 rounded">
                   ...
                   <div className="text-muted-foreground">{t('game.summaryTotalDuration')}</div>
                 </div>
               </div>
             </div>
           </Card>
     ...
     return (
       <div className="space-y-6">
         <div className="text-center">
           <h2 className="text-3xl font-bold mb-4">{t('game.finishedTitle')}</h2>
           <div className="text-xl mb-6">
             <span className="text-yellow-400">{t('game.winner', { name: winner.name })}</span>
             <br />
             <span className="text-muted-foreground">{t('game.winnerSips', { count: totalSips[winner.id] })}</span>
           </div>
         </div>

         <Card className="p-6">
           <h3 className="text-xl font-semibold mb-4">{t('game.summaryTitle')}</h3>
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
             <div className="text-center p-3 bg-gray-800 rounded">
               <div className="text-2xl font-bold text-blue-400">{config.zoneCount}</div>
               <div className="text-sm text-muted-foreground">{t('game.zonesPlayed')}</div>
             </div>
             <div className="text-center p-3 bg-gray-800 rounded">
               <div className="text-2xl font-bold text-green-400">{totalGorgées}</div>
               <div className="text-sm text-muted-foreground">{t('game.totalSips')}</div>
             </div>
             <div className="text-center p-3 bg-gray-800 rounded">
               <div className="text-2xl font-bold text-yellow-400">{averageGorgées}</div>
               <div className="text-sm text-muted-foreground">{t('game.averagePerPlayer')}</div>
             </div>
             <div className="text-center p-3 bg-gray-800 rounded">
               <div className="text-2xl font-bold text-purple-400">{config.zoneRadius}px</div>
               <div className="text-sm text-muted-foreground">{t('game.zoneSizeLabel')}</div>
             </div>
           </div>
         </Card>

         <Card className="p-6">
           <h3 className="text-xl font-semibold mb-4">{t('game.finalRanking')}</h3>
               ...
               return (
                 ...
                 >
                   ...
                   <div className="text-right">
                     <div className="font-bold text-lg">{t('game.sipsCount', { count: totalSips[player.id] })}</div>
                     <div className="text-sm text-muted-foreground">
                       {t('game.percentOfTotal', { percent: Math.round((totalSips[player.id] / totalGorgées) * 100) })}
                     </div>
                   </div>
                 </div>
               )
         ...
         <Card className="p-6">
           <h3 className="text-xl font-semibold mb-4">{t('game.statsTitle')}</h3>
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
             <div>
               <h4 className="font-semibold mb-2 text-green-400">{t('game.configUsed')}</h4>
               <ul className="space-y-1 text-sm text-muted-foreground">
                 <li>{t('game.configUsedZones', { count: config.zoneCount })}</li>
                 <li>{config.sipsPerZone > 1
                   ? t('game.configUsedSipsPlural', { count: config.sipsPerZone })
                   : t('game.configUsedSips', { count: config.sipsPerZone })}</li>
                 <li>{t('game.configUsedRadius', { radius: config.zoneRadius })}</li>
                 <li>{t('game.configUsedDuration', { seconds: config.zoneDuration / 1000 })}</li>
                 <li>{t('game.configUsedDelay', { seconds: config.spawnDelay / 1000 })}</li>
               </ul>
             </div>
             <div>
               <h4 className="font-semibold mb-2 text-blue-400">{t('game.performance')}</h4>
               <ul className="space-y-1 text-sm text-muted-foreground">
                 <li>{t('game.perfTotalDuration', { seconds: Math.round((config.zoneCount * (config.zoneDuration + config.spawnDelay)) / 1000) })}</li>
                 <li>{t('game.perfSipsPerZone', { count: config.sipsPerZone })}</li>
                 <li>{t('game.perfMaxSips', { count: config.zoneCount * config.sipsPerZone * players.length })}</li>
                 <li>{t('game.perfEfficiency', { percent: Math.round((totalGorgées / (config.zoneCount * config.sipsPerZone * players.length)) * 100) })}</li>
               </ul>
             </div>
           </div>
         </Card>
  ...
  return (
    <GameShell
      ...
      actionBar={
        ...
        >
          {currentRound >= config.zoneCount ? t('game.endGame') : t('game.nextZone')}
        </Button>
      }
    >
             <div className="flex justify-center">
        ...
        {playersInZone.length > 0 && (
          <Card className="p-4 bg-yellow-500/10 border-yellow-500/20">
            <h3 className="text-lg font-semibold mb-2 text-yellow-400">{t('game.playersInZone')}</h3>
              ...
              {playersInZone.map(playerId => {
                ...
                return (
                  <div key={playerId} className="px-3 py-1 bg-yellow-500/20 rounded-full text-yellow-300">
                    {config.sipsPerZone > 1
                      ? t('game.playerSipsPlural', { name: player?.name ?? '', count: config.sipsPerZone })
                      : t('game.playerSips', { name: player?.name ?? '', count: config.sipsPerZone })}
                  </div>
                )
              })}
            </div>
        ...
        <Card className="p-4">
          <h3 className="text-lg font-semibold mb-3">{t('game.totalSipsTitle')}</h3>
            ...
            {players.map((player, index) => {
              ...
              return (
                <div key={player.id} className="flex items-center gap-2 p-2 bg-gray-800 rounded">
                  ...
                  <span className="ml-auto font-semibold">{t('game.sipsCount', { count: totalSips[player.id] })}</span>
                </div>
              )
            })}
          </div>
