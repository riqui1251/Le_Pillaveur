...
export default function Monsieur3Page() {
  ...
  const handleGameEnd = () => router.push('/jeux')

  if (selectedPlayers.length >= 2) {
    return <Game players={selectedPlayers} onGameEnd={handleGameEnd} />
  }
      ...
      <div className="mx-auto max-w-md px-4 py-8 space-y-5">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-white/40">{tCatalog('monsieur-3.description')}</p>
          </div>
          <Link
            href="/jeux"
