...
export default function TelephoneDessinePage() {
  ...
  const tCatalog = useTranslations('games.catalog.telephone-dessine')
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gray-950 text-white">
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-teal-600/20 blur-[120px] animate-[pulse_8s_ease-in-out_infinite]" />
        <div className="absolute bottom-0 -left-40 h-80 w-80 rounded-full bg-indigo-600/15 blur-[100px] animate-[pulse_10s_ease-in-out_infinite_2s]" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-lg flex-col items-center justify-center px-4 py-10">
        <div className="w-full rounded-3xl border border-white/10 bg-white/5 p-6 text-center shadow-2xl backdrop-blur-md">
          <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-700 to-indigo-600 text-4xl shadow-lg shadow-indigo-500/30">
            <GameIconById id="telephone-dessine" className="text-4xl" />
          </div>
          ...
          {user ? (
            <Button
              ...
              className="w-full rounded-2xl bg-gradient-to-r from-teal-700 to-indigo-600 py-5 text-base font-bold text-white shadow-lg shadow-indigo-500/25 transition-all hover:from-teal-600 hover:to-indigo-500"
            >
            ...
            <TryBotsGate
              gameId="telephone-dessine"
              accentClassName="w-full rounded-2xl bg-gradient-to-r from-teal-700 to-indigo-600 py-5 text-base font-bold text-white shadow-lg shadow-indigo-500/25 hover:from-teal-600 hover:to-indigo-500"
            />
          )}
        </div>
      </div>
