 ...
 * chacun joue depuis son propre téléphone.
 */
export default function PresidentPage() {
  const t = useTranslations('games.president.page')
  const tCatalog = useTranslations('games.catalog.president')
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gray-950 text-white">
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-emerald-800/25 blur-[120px] animate-[pulse_8s_ease-in-out_infinite]" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-lg flex-col items-center justify-center px-4 py-10">
        <div className="w-full rounded-3xl border border-white/10 bg-white/5 p-6 text-center shadow-2xl backdrop-blur-md">
          <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-800 to-amber-600 text-4xl shadow-lg shadow-emerald-500/30">
            <GameIconById id="president" className="text-4xl" />
          </div>
          ...
          {user ? (
            <Button
              ...
              className="w-full rounded-2xl bg-gradient-to-r from-emerald-800 to-amber-600 py-5 text-base font-bold text-white shadow-lg shadow-emerald-500/25 transition-all hover:from-emerald-700 hover:to-amber-500"
            >
              <Globe className="mr-2 h-4 w-4" />
              {t('switchOnline')}
            </Button>
          ) : (
            <Button asChild className="w-full rounded-2xl bg-gradient-to-r from-emerald-800 to-amber-600 py-5 text-base font-bold text-white shadow-lg shadow-emerald-500/25 hover:from-emerald-700 hover:to-amber-500">
