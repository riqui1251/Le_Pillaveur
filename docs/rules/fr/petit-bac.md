...
- L'hôte choisit le nombre de manches (**3, 5 ou 8**) — une lettre différente
  à chaque manche, jamais deux fois la même.
- 2 minutes maximum par manche d'écriture (mais un STOP écourte tout).
- À la fin, le joueur avec le **plus de points cumulés** gagne — victoires et
  rangs comptent au classement en ligne du Pillaveur.
