...
docker run --rm -v le-pillaveur-db:/data alpine sh -c 'apk add sqlite >/dev/null 2>&1; sqlite3 /data/prod.db "PRAGMA table_info(User);" | grep lastIp'
